...
option_list = list(
  ...
  make_option(c("--ignore_duplicates"), action="store_true", type="logical", default=FALSE, help="Flag to include duplicates", metavar="character"),
...
bamcounts <- featureCounts(bam_files, 
                           ...
                           ignoreDup = opt$ignore_duplicates, 
