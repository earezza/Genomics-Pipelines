    ...
    tryCatch(
      {
        ...
        if (!is.null(compGO)){
          plt <- dotplot(compGO, showCategory = 5, title = paste("GO Pathway Enrichment Analysis -", n, sep=""))
    ...
    tryCatch(
      {
        ...
        if (!is.null(compKEGG)){
          plt <- dotplot(compKEGG, showCategory = 10, title = paste("KEGG Pathway Enrichment Analysis -", n, sep=""))
    ...
    tryCatch(
      {
        ...
        if (!is.null(gsea)){
          plt <- dotplot(gsea, showCategory = 10, title = paste("GO Set Enrichment Analysis -", n, sep=""))
